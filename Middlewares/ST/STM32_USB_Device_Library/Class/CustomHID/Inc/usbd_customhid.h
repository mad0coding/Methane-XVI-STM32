...
#define CUSTOM_HID_EPIN_SIZE				0x40U//上行端点64字节

#define CUSTOM_HID_EPOUT_ADDR				0x01U//自定义HID使用下行端点1
#define CUSTOM_HID_EPOUT_SIZE				0x40U//下行端点64字节

#define HID_EPIN_ADDR						0x82U//HID使用上行端点2
#define HID_EPIN_SIZE						22U//上行端点22字节

#define USBD_CUSTOM_HID_INTERFACE			0//自定义HID接口编号
#define USBD_HID_INTERFACE					1//HID接口编号

#define USB_CUSTOM_HID_CONFIG_DESC_SIZ		66U//41U//配置描述符长度
